  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 bg-dark-gray border border-white/20 rounded-lg px-4 py-2 text-white text-sm"
      >
        ...
        Filter
        {activeFilterCount > 0 && (
          <span className="bg-champagne text-black text-xs rounded-full w-5 h-5 flex items-center justify-center">
            {activeFilterCount}
          </span>
        )}
      </button>
