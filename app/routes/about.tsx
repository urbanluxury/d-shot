        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6 text-white/80 text-lg leading-relaxed">
              {/* Quick Facts */}
              <div className="grid grid-cols-2 gap-4 p-6 bg-dark-gray rounded-lg mb-8">
                <div>
                  <p className="text-white/50 text-sm uppercase tracking-wider">Born</p>
                  <p className="text-champagne font-display text-xl">December 12, 1969</p>
                </div>
                <div>
                  <p className="text-white/50 text-sm uppercase tracking-wider">Origin</p>
                  <p className="text-champagne font-display text-xl">Vallejo, CA</p>
                </div>
                <div>
                  <p className="text-white/50 text-sm uppercase tracking-wider">Label</p>
                  <p className="text-champagne font-display text-xl">Shot Records</p>
                </div>
                <div>
                  <p className="text-white/50 text-sm uppercase tracking-wider">Active</p>
                  <p className="text-champagne font-display text-xl">1986 - Present</p>
                </div>
              </div>
              ...
              <p>
                <strong className="text-champagne">Danell LaShawn Stevens Sr.</strong>, better known as
              ...
              <p>
                In 1986, D-Shot joined forces with his brother <strong className="text-white">Earl Stevens (E-40)</strong>,
                sister <strong className="text-white">Suga-T</strong>, and cousin <strong className="text-white">B-Legit</strong>
                to form <strong className="text-champagne">The Most Valuable Players</strong>, later known as
                <strong className="text-champagne"> The Click</strong>. The family group made their mark at a
              ...
              <p>
                ...
                <strong className="text-white"> Sick Wid It Records</strong>, each member pursued solo careers.
                D-Shot's debut album, <strong className="text-champagne">The Shot Calla</strong> (1993),
              ...
              <p>
                In 1995, D-Shot founded his own label, <strong className="text-champagne">Shot Records</strong>,
                demonstrating the entrepreneurial spirit that runs in the Stevens family. His second album,
                <em className="text-white"> Six Figures</em> (1997), was released through Shot Records in
              ...
              <div className="pt-8 border-t border-gray">
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">The Shot Calla</span>
                      <span className="text-white/40 text-sm ml-2">Sick Wid It Records</span>
                    </div>
                    <span className="text-white/50">1993</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">Six Figures</span>
                      <span className="text-white/40 text-sm ml-2">Shot Records / Jive</span>
                    </div>
                    <span className="text-white/50">1997</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">Money, Sex & Thugs</span>
                      <span className="text-white/40 text-sm ml-2">Shot Records</span>
                    </div>
                    <span className="text-white/50">2001</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">Bosses in the Booth</span>
                      <span className="text-white/40 text-sm ml-2">Shot Records</span>
                    </div>
                    <span className="text-white/50">2004</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">Callin All Shots</span>
                      <span className="text-white/40 text-sm ml-2">Shot Records</span>
                    </div>
                    <span className="text-white/50">2006</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <div>
                      <span className="text-champagne">Presidential</span>
                      <span className="text-white/40 text-sm ml-2">Shot Records</span>
                    </div>
                    <span className="text-white/50">2009</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="pt-8 border-t border-gray">
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    ...
                    <span className="text-white/50">1992</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <span className="text-champagne">Game Related</span>
                    <span className="text-white/50">1995</span>
                  </li>
                  <li className="flex justify-between items-center py-3 border-b border-gray/50">
                    <span className="text-champagne">Money & Muscle</span>
                    <span className="text-white/50">2001</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-dark-gray rounded-lg p-6 text-center">
              <div className="w-20 h-20 rounded-full bg-merlot/30 mx-auto mb-4 flex items-center justify-center text-3xl">
                👤
              </div>
              <h3 className="font-display uppercase text-champagne text-xl">E-40</h3>
              <p className="text-white/50 text-sm">Brother</p>
            </div>
            <div className="bg-dark-gray rounded-lg p-6 text-center">
              <div className="w-20 h-20 rounded-full bg-merlot/30 mx-auto mb-4 flex items-center justify-center text-3xl">
                👤
              </div>
              <h3 className="font-display uppercase text-champagne text-xl">D-Shot</h3>
              <p className="text-white/50 text-sm">Brother</p>
            </div>
            <div className="bg-dark-gray rounded-lg p-6 text-center">
              <div className="w-20 h-20 rounded-full bg-merlot/30 mx-auto mb-4 flex items-center justify-center text-3xl">
              ...
              <h3 className="font-display uppercase text-champagne text-xl">Suga-T</h3>
              <p className="text-white/50 text-sm">Sister</p>
            </div>
            <div className="bg-dark-gray rounded-lg p-6 text-center">
              <div className="w-20 h-20 rounded-full bg-merlot/30 mx-auto mb-4 flex items-center justify-center text-3xl">
                👤
              </div>
              <h3 className="font-display uppercase text-champagne text-xl">B-Legit</h3>
              <p className="text-white/50 text-sm">Cousin</p>
            </div>
          </div>
        </div>
      </section>
