...
export default function Product() {
  ...
  return (
    <div className="product-page min-h-screen">
      {/* White background product section */}
        ...
        <div className="container py-12">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="product-info flex flex-col">
              ...
              <h1 className="text-4xl md:text-5xl font-display uppercase text-black mb-4">
                {title}
              </h1>
              <div className="text-3xl text-merlot font-display mb-8">
                <ProductPrice
              ...
              <div className="border-t border-black/10 pt-8 mt-auto">
                <h3 className="text-lg font-display uppercase text-black mb-4">
                  Description
                </h3>
                <div
